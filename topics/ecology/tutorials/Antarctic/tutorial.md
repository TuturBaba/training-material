...
## Sub-step with **downloads**

> <hands-on-title> Task description </hands-on-title>
>
> 1. {% tool [downloads](lftp) %} with the following parameters:
>    - {% icon param-file %} *"File with URLs"*: `outfile` (output of **Create text file** {% icon tool %})
>
...
>    - {% icon param-file %} *"Collection of files to collapse into single dataset"*: `downloads` (output of **downloads** {% icon tool %})
>
>    ***TODO***: *Check parameter descriptions*
>
>    ***TODO***: *Consider adding a comment or tip box*
...
>
> 1. {% tool [Collapse Collection](toolshed.g2.bx.psu.edu/repos/nml/collapse_collections/collapse_dataset/5.1.0) %} with the following parameters:
>    - {% icon param-file %} *"Collection of files to collapse into single dataset"*: `output_collection` (output of **Interactive JupyterLab Notebook** {% icon tool %})
>
>    ***TODO***: *Check parameter descriptions*
>
>    ***TODO***: *Consider adding a comment or tip box*
...
> <hands-on-title> Task description </hands-on-title>
>
> 1. {% tool [Copernicus Climate Data Store](toolshed.g2.bx.psu.edu/repos/climate/c3s/c3s/0.3.0) %} with the following parameters:
>    - *"C3S request is a given as a filename"*: `yes`
>        - {% icon param-file %} *"API Request filename"*: `output_dataset` (output of **Interactive JupyterLab Notebook** {% icon tool %})
>
>    ***TODO***: *Check parameter descriptions*
>
>    ***TODO***: *Consider adding a comment or tip box*
